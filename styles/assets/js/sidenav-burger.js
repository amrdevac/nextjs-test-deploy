...
if (typeof window !== "undefined") {
  var sidenav = document.getElementById("aside");
  var sidenav_trigger = document.getElementById("sidenav-trigger");
  var sidenav_close_button = document.getElementById("sidenav-close");
